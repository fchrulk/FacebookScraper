...
class FacebookScraper():
    ...
    def GetTargetPosts(self, engine, target_id, add_field=None, remove_field=None, day_limit=7, count_limit=None, GMT='+7:00', cleaning_message=True):
        """
        ...
        """
        return _PostScraper.get_post_data(engine, target_id, add_field, remove_field, day_limit, count_limit, GMT, cleaning_message)

    def GetPostComments(self, engine, target_id, add_field=None, remove_field=None, count_limit='all', GMT='+7:00', cleaning_message=True):
        """
        ...
        """
        return _CommentScraper.get_comment_data(engine, target_id, add_field, remove_field, count_limit, GMT, cleaning_message)
